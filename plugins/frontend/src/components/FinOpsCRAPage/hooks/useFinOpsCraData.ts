...
import { mockFinOpsDataSource, type FinOpsDataSource } from '../../../data/finopsDataSource';
import {
  ALL_USAGE_METRICS,
  type CostMetric,
  type ProviderType,
...
export function useFinOpsCraData(dataSource: FinOpsDataSource = mockFinOpsDataSource) {
